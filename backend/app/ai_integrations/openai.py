...
OpenAI provider implementation via the Chat Completions REST API.
Uses plain HTTP (requests) rather than the openai SDK so this module has
no hard dependency beyond `requests`.
"""
...
class OpenAIProvider(AIProvider):
    ...
    def _call(self, prompt: str, **kwargs: Any) -> AIResponse:
        ...
        return AIResponse(
            ...
            latency_ms=0,  # overwritten by AIProvider.generate()
            usage=TokenUsage(
